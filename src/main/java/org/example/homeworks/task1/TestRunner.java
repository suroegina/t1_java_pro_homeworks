...
import org.example.homeworks.task1.Errors.BadTestClassError;
import org.example.homeworks.task1.Errors.TestAssertionError;
...
public class TestRunner {
    public static Map<TestResult, List<Test>> runTest(Class<?> c) {
        ...
        for (Method method : c.getDeclaredMethods()) {
            ...
            } else if (method.isAnnotationPresent(org.example.homeworks.task1.Annotations.Test.class)) {
                if (Modifier.isStatic(method.getModifiers())) {
    ...
    private static String getTestName(Method method){
        org.example.homeworks.task1.Annotations.Test testAnnotation = method.getAnnotation(org.example.homeworks.task1.Annotations.Test.class);
